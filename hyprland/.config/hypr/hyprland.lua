...
hl.bind(
	mainMod .. " + return",
	hl.dsp.exec_cmd("(pidof " .. terminal .. " && " .. terminal .. ") || " .. terminal .. " tmux")
)
...
hl.bind(mainMod .. " + SHIFT + Z", hl.dsp.exec_cmd("zen-browser --private-window"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("hyprlock"))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("mpv --player-operation-mode=pseudo-gui --"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"))
hl.bind(mainMod .. " + SHIFT + O", hl.dsp.exec_cmd("systemctl suspend"))
hl.bind(
	mainMod .. " + V",
	hl.dsp.exec_cmd("cliphist list | wofi --show dmenu -H 600 -W 1250 | cliphist decode | wl-copy")
)
hl.bind(
	mainMod .. " + SHIFT + V",
	hl.dsp.exec_cmd("cliphist list | wofi --show dmenu -H 600 -W 1250 | cliphist delete")
)
...
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("exec, hyprpanel toggleWindow settings-dialog"))
...
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("brightnessctl -e4 -n12 set 2%+"))
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("brightnessctl -e4 -n12 set 2%-"))
hl.bind(mainMod .. " + SHIFT + D", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"))
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"))
hl.bind(mainMod .. " + SHIFT + ALT + D", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"))
hl.bind(mainMod .. " + SHIFT + ALT + A", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"))

hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("~/scripts/cliphistToggle.sh"))
hl.bind(mainMod .. " + SHIFT + I", hl.dsp.exec_cmd("~/scripts/hypridleToggle.sh"))

hl.bind(mainMod .. " + Tab", function()
	hl.config({ general = { layout = "dwindle" } })
end) --switch to dwindle layout

hl.bind(mainMod .. " + SHIFT + Tab", function()
	hl.config({ general = { layout = "master" } })
end) --switch to master layout
...
hl.bind(mainMod .. " + ALT + H", hl.dsp.window.resize({ x = -200, y = 0, relative = true }))
hl.bind(mainMod .. " + ALT + L", hl.dsp.window.resize({ x = 200, y = 0, relative = true }))
hl.bind(mainMod .. " + ALT + K", hl.dsp.window.resize({ x = 0, y = -200, relative = true }))
hl.bind(mainMod .. " + ALT + J", hl.dsp.window.resize({ x = 0, y = 200, relative = true }))

-- Switch workspaces with
hl.bind(mainMod .. " + comma", hl.dsp.focus({ workspace = "-1" }))
hl.bind(mainMod .. " + period", hl.dsp.focus({ workspace = "+1" }))
-- hl.bind(mainMod .. " + comma", hl.dsp.focus({ workspace = "e-1" })) --skip empty workspaces
-- hl.bind(mainMod .. " + period", hl.dsp.focus({ workspace = "e+1" })) --skip empty workspaces
